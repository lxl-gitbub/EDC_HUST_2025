...
int main(void)
{
  ...
  while (1)
  {
		...
		if(g_new_package_flag == 1 && straight_flag < 17)
		{
			...
			else if(IR_Data_number[0] == 1 && IR_Data_number[1] == 1 && IR_Data_number[2] == 1 && IR_Data_number[3] == 1 && IR_Data_number[4] == 1 && IR_Data_number[5] == 1 && IR_Data_number[6] == 1 && IR_Data_number[7] == 1 && (straight_flag == 2 || straight_flag == 6 || straight_flag == 10 || straight_flag == 14)){
			//第二、四、六、八次进入全白区域（直接转大一点）
			...
			else if(IR_Data_number[0] == 1 && IR_Data_number[1] == 1 && IR_Data_number[2] == 1 && IR_Data_number[3] == 1 && IR_Data_number[4] == 1 && IR_Data_number[5] == 1 && IR_Data_number[6] == 1 && IR_Data_number[7] == 1 && (straight_flag == 4 || straight_flag == 8 || straight_flag == 12)){
			//第三、五、七次进入全白区域（直接转大一点）
			MotorSet(BACK,300,&Right);
			MotorSet(FOR,300,&Left);
			enable_Buzzer();
			HAL_Delay(225);
			...
			else if(IR_Data_number[0] == 1 && IR_Data_number[1] == 1 && IR_Data_number[2] == 1 && IR_Data_number[3] == 1 && IR_Data_number[4] == 1 && IR_Data_number[5] == 1 && IR_Data_number[6] == 1 && IR_Data_number[7] == 1 && straight_flag ==16){
			//第九次进入全白区域（停车）
