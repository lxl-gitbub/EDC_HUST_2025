...
void lineWalking(){
	...
	if( (x1 == 0 || x2 == 0 || x3 == 0 || x4 == 0 || x5 == 0 || x6 == 0 || x7 == 0 || x8 == 0) && straight_flag == 1){
		...
		enable_Buzzer();
		enable_Buzzer();
		MotorSet(FOR,600,&Right);
		MotorSet(FOR,300,&Left);
		HAL_Delay(300);
	}
	else if( (x1 == 0 || x2 == 0 || x3 == 0 || x4 == 0 || x5 == 0 || x6 == 0 || x7 == 0 || x8 == 0) && (straight_flag == 3 || straight_flag == 7 || straight_flag == 11 || straight_flag == 15)){
		straight_flag ++;
		enable_Buzzer();
	...
	else if( (x1 == 0 || x2 == 0 || x3 == 0 || x4 == 0 || x5 == 0 || x6 == 0 || x7 == 0 || x8 == 0) && (straight_flag == 5 || straight_flag == 9 || straight_flag == 13)){
		straight_flag ++;
		enable_Buzzer();
		MotorSet(FOR,300,&Left);
		MotorSet(FOR,600,&Right);
