...
int main(void)
{
  ...
  while (1)
  {
		...
		if(g_new_package_flag == 1 && straight_flag < 5)
		{
			...
			if(IR_Data_number[0] == 1 && IR_Data_number[1] == 1 && IR_Data_number[2] == 1 && IR_Data_number[3] == 1 && IR_Data_number[4] == 1 && IR_Data_number[5] == 1 && IR_Data_number[6] == 1 && IR_Data_number[7] == 1 && straight_flag == 2){
			//如果探测到全白，且刚进入全白
			MotorSet(FOR,500,&Right);
			MotorSet(FOR,425,&Left);
			enable_Buzzer();
			HAL_Delay(500);
			...
			else if(IR_Data_number[0] == 1 && IR_Data_number[1] == 1 && IR_Data_number[2] == 1 && IR_Data_number[3] == 1 && IR_Data_number[4] == 1 && IR_Data_number[5] == 1 && IR_Data_number[6] == 1 && IR_Data_number[7] == 1 && straight_flag ==0){
			MotorSet(FOR,300,&Right);
			MotorSet(FOR,300,&Left);
			enable_Buzzer();
			straight_flag = 1;			
